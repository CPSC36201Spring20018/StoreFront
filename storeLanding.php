             ...
             <tbody>
               <?php
                 ...
                 while($stmt->fetch()){
                   ...
                   if ($proactive == 0) {
                      echo "<td width=\"100px\"><button style =\"background-color:red; box-shadow: 1px 1px;\"><a href=\"changeActive.php?active=".$proactive."&proid=".$pronum."\" style =\"color: white\">Inactive</a></button></td>";
                   }
                   else{
